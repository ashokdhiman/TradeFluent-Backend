...
import com.trade.repository.AssetsRepository;
...
//    }
    ...
    @Override
    public Asset getAssetByUserAndId(String userId, String assetId) {
    ...
    @Override
    public Asset findAssetByUserIdAndCoinId(String userId, String coinId) throws Exception {
